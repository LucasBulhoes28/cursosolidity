...
//Definicao dos paramentros
    ...
    address payable votante;
    mapping(address => bool) public votante;
...
//Utilizacao de constructor e event para definir prazo da votacao 

   constructor (uint256 prazoFinalVotacao, address payable votante) {
